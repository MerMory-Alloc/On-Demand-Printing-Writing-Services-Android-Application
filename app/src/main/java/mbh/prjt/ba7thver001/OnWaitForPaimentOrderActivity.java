...
public class OnWaitForPaimentOrderActivity extends AppCompatActivity {
    ...
    ValueEventListener mValueListner=new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot snapshot) {
            ...
            final AdminServiceListAdapter onWaitServiceAdapter=new AdminServiceListAdapter(getApplicationContext(),R.layout.list_services,listofonwaitservices);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_wait_for_paiment_order);
