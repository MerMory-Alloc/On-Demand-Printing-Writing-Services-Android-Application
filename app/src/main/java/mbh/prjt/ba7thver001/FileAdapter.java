...
public class FileAdapter extends ArrayAdapter<Uri> {
    ...
    public FileAdapter(Context context, int id,ArrayList<Uri> list) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent){
        ...
        if(convertView==null){
            ...
            convertView= LayoutInflater.from(getContext()).inflate(R.layout.gridfileloks,parent,false);
