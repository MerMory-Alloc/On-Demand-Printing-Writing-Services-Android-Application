...
public class ClientRefusedActivity extends AppCompatActivity {
        ...
        public void onDataChange(@NonNull DataSnapshot snapshot) {
            ...
            for (DataSnapshot snap:snapshot.getChildren()) {
                ...
                if (value.getServiceRequesterId()==currentClientId) {
                    if ((value.getServiceState().equals("refused"))||(value.getServiceState().equals("refused_deleted_bySP"))) {
                        listofrefusedservices.add(value);
                    }
                }
            }
            progressBar.setVisibility(View.INVISIBLE);
            final ServiceListAdapter refusedServiceAdapter=new ServiceListAdapter(getApplicationContext(),R.layout.list_element,listofrefusedservices);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client_refused);
