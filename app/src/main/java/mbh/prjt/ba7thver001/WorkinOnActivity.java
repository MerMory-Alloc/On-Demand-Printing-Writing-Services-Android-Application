...
public class WorkinOnActivity extends AppCompatActivity {
    ...
    ValueEventListener mValueListner=new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot snapshot) {
            ...
            final AdminServiceListAdapter workingOnServiceAdapter=new AdminServiceListAdapter(getApplicationContext(),R.layout.list_services,listofworkingonservices);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workin_on);
