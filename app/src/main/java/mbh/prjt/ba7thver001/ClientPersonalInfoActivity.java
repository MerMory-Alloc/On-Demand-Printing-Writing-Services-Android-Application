...
public class ClientPersonalInfoActivity extends AppCompatActivity {

    private static final Pattern USERNAME_PATTERN =
            Pattern.compile("^[a-zA-Z]{1}\\w{4,30}$");/////////////////////////////////////////////////////////

    EditText nameView,emailView,phoneView,firstView,lastView,birthdaypicker;
    Button editBtn,saveBtn,cancelBtn;
    String name,email,phone,firstname,lastname,birthdayStr,dayall;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        birthdaypicker=(EditText) findViewById(R.id.datePicker1);
        ...
        clientRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                client=snapshot.child(user.getUid()).getValue(Client.class);
                name=client.getServiceRequesterName();
                firstname=client.getServiceRequesterFirstName();
                lastname=client.getServiceRequesterLastName();
                email=client.getServiceRequesterEmail();
                phone=client.getServiceRequesterPhone();
                birthdayStr=client.getServiceRequesterBirthDay();

                birthdaypicker.setText(birthdayStr);
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(nameStr) || TextUtils.isEmpty(emailStr) || TextUtils.isEmpty(phonStr) || TextUtils.isEmpty(firstStr) || TextUtils.isEmpty(lastStr)) {
                    ...
                    final AlertDialog.Builder builder = new AlertDialog.Builder(ClientPersonalInfoActivity.this);
                    ...
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            // User clicked OK button
                                ...
                                client.setServiceRequesterEmail(emailStr);
                                ...
                                client.setServiceRequesterBirthDay(birthDay);

                                clientRef.child(user.getUid()).setValue(client);
   ...
   /* public void convertToDay(String str){
    ...
    public void convertToString(DatePicker dtp){
