...
public class ClientFinishedActivity extends AppCompatActivity {
        ...
        public void onDataChange(@NonNull DataSnapshot snapshot) {
            ...
            for (DataSnapshot snap:snapshot.getChildren()) {
                ...
                if (value.getServiceRequesterId()==currentClientId) {
                    if ((value.getServiceState().equals("finished"))||(value.getServiceState().equals("delivered_bySP"))) {
                        listoffinishedservices.add(value);
                    }
                }
            }
            progressBar.setVisibility(View.INVISIBLE);
            final ServiceListAdapter finishedServiceAdapter=new ServiceListAdapter(getApplicationContext(),R.layout.list_element,listoffinishedservices);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client_finished);
